...
#define kIID_TempBulb                 ((uint64_t) 0x0034)
#define KIID_Temp                      ((uint64_t) 0x0035)
...
/**/
const HAPFloatCharacteristic lighttemp = {
    ...
    .properties = { .readable = true,
                    ...
                    .ble = { .supportsBroadcastNotification = false,
                             ...
                             .readableWithoutSecurity = false,
                             .writableWithoutSecurity = false } },
    .constraints = { .minimumValue = 10.0, .maximumValue = 38.0, .stepValue = 0.1 },
    .callbacks = { .handleRead = HandleTemp, .handleWrite = NULL }
};
/**/
/**
...
const HAPService TemperatureSensorService = {
    ...
    .properties = { .primaryService = true, .hidden = false, .ble = { .supportsConfiguration = false } },
    .linkedServices = NULL,
    .characteristics = (const HAPCharacteristic* const[]) { &lighttemp,
                                                            NULL }
};
